...
replace (
	github.com/docker/cli v24.0.4+incompatible => github.com/docker/cli v20.10.21+incompatible
	github.com/docker/distribution v2.8.2+incompatible => github.com/docker/distribution v2.8.2-beta.1+incompatible
	// github.com/docker/docker v24.0.0-rc.2.0.20230718135204-8e51b8b59cb8+incompatible => github.com/docker/docker v20.10.24+incompatible
