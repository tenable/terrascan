...
func (t *TfV14) LoadIacDir(absRootDir string) (allResourcesConfig output.AllResourceConfigs, err error) {
	return commons.LoadIacDir(absRootDir, t.NonRecursiveScan)
}
