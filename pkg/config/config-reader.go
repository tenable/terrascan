...
// GetCategories will return the list of categories specified in the terrascan config file
func (r TerrascanConfigReader) GetCategories() []string {
	return r.config.Category.list
}
